...
public class TestCases {
    ...
    public  void testCase01(){
       ...
       System.out.println("Number of washing machines with less than or equal to 4 stars: " + coun);
  ...
  printItemsWithDiscount(driver, "iPhone", 17);
    ...
    public static void printTopRatedItems(WebDriver driver, String searchQuery, int minRating, int count) {
    	...
    	WebElement selectRating= driver.findElement(By.xpath("//div[contains(text(),'4★ & above')]"));
